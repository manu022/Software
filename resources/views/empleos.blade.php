        ...
        <div class="row projects">
            <div class="col-lg-6">
                <div class="hpanel hgreen">
                    <div class="panel-body">
                        <button class="btn btn-xs btn-default pull-right"> Sitio Web</button>
                        <div class="row">
                            <div class="col-sm-10">
                                <h4>Cargo</h4>
                                <h5 class="text-success">Empresa</h5></br>

                                <p>
                                    <b>Espas Travay:</b> Macul, Región Metropolitana</br>
                                    <b>Dat piblikasyon:</b> 18-01-2019</br>
                                    <b>Salè:</b> No especificado</br>
                                    <b>Kalite pozisyon:</b> Full-Time</br>
                                    <b>Zòn:</b> Comercial</br>
                                </p>
                    ...
                    <div class="panel-footer">
                        <a href="" class="btn btn-primary btn-sm">POSTILLA <small>(POSTULAR)</small></a>
                    </div>
                </div>
            </div>
